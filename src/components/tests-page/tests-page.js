                            ...
                            <div className="ts-category__container">
                                <div className="test-list__wrap">
                                    ...
                                    <div className="test-list-description">
                                        ...
                                        <Link to="tests/html-test">Перейти к тесту</Link>
                                    </div>
                                </div>
                            </div>
                            <hr style={{width: '850px', background: '#fff', marginTop: '50px'}} />
                            <div className="ts-category__container">
                                <div className="test-list__wrap">
                                    ...
                                    <div className="test-list-description">
                                        ...
                                        <Link to="tests/php-test">Перейти к тесту</Link>
                                    </div>
                                </div>
                            </div>
                            <hr style={{width: '850px', background: '#fff', marginTop: '50px'}} />
                            <div className="ts-category__container">
                                <div className="test-list__wrap">
                                    ...
                                    <div className="test-list-description">
                                        ...
                                        <Link to="tests/css-test">Перейти к тесту</Link>
                                    </div>
                                </div>
                            </div>
                            <hr style={{width: '850px', background: '#fff', marginTop: '50px'}} />
                            <div className="ts-category__container">
                                <div className="test-list__wrap">
                                    ...
                                    <div className="test-list-description">
                                        ...
                                        <Link to="tests/javascript-test">Перейти к тесту</Link>
                                    </div>
                                </div>
                            </div>
                            <hr style={{width: '850px', background: '#fff', marginTop: '50px'}} />
                            <div className="ts-category__container">
                                <div className="test-list__wrap">
                                    ...
                                    <div className="test-list-description">
                                        ...
                                        <Link to="tests/sql-test">Перейти к тесту</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
